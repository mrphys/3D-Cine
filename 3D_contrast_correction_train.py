...
from custom_unet_code import build_3d_unet_resp
...
class CustomDataGen():    
    ...
    def data_generator(self):
        ...
        for patient in self.patients:
            ...
            yield z_stand(image), z_stand(target)  # Normalise both datasets before outputs
...
unet_model  = build_3d_unet_resp(input_shape=(28,256,128,1),num_classes=1)
...
num_epochs = 500
model_name = 'contrast_correction_model'
